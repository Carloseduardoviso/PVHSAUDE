...
namespace PVHSAUDE.Infra.Data.Migrations
{
    ...
    [Migration("20260925002320_EmailDependenteELembretes")]
    partial class EmailDependenteELembretes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PVHSAUDE.Domain.Entities.CredenciadoImagem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CredenciadoId", "CriadoEm", "Id");

                    b.ToTable("CredenciadoImagem", (string)null);
            ...
            modelBuilder.Entity("PVHSAUDE.Domain.Entities.EmailLembrete", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PessoaId", "DataValidade", "DiasAntes")
                        .IsUnique();

                    b.ToTable("EmailLembrete", (string)null);
