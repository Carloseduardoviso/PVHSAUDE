...
public static class UsuarioDatabaseTests
{
    public static async Task Run()
    {
        ...
        try
        {
            ...
            var controller = new UsuariosController(db, hasher);
            ...
            var auth = new AuthController(db, hasher, jwt);
            ...
            var banners = new BannersController(db) { ControllerContext = new ControllerContext { HttpContext = new DefaultHttpContext() } };
